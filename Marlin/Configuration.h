...
#define STRING_CONFIG_H_AUTHOR "(doobry, Ender 3 Direct)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 3 Direct"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 with Aero
  #define DEFAULT_Kp 10.40
